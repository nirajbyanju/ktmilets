      ...
      <div className="flex w-full flex-col items-center justify-center p-10 md:w-2/3">
        <div className="w-full max-w-md">
          ...
          <button
            type="button"
            onClick={() => {
              const backendApi = (process.env.NEXT_PUBLIC_API_URL ?? '').replace(/\/v1$/, '');
              window.location.href = `${backendApi}/google/redirect`;
            }}
            className="mb-4 flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white p-3 transition hover:bg-gray-50"
          >
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            <div className="relative mb-5">
              <input
                ...
                id="email"
                {...register("email")}
                className={`block w-full appearance-none rounded-lg border-2 bg-transparent py-3.5 ps-6 pe-0 text-sm text-gray-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-opsh-primary/20 peer ${
                  errors.email ? "border-red-500" : "border-gray-200 focus:border-opsh-primary"
                }`}
                placeholder=" "
              />
              <label
            ...
            <div className="relative mb-5">
              <div className="relative">
                <input
                  ...
                  id="password"
                  {...register("password")}
                  className={`block w-full appearance-none rounded-lg border-2 bg-transparent py-3.5 ps-6 pe-10 text-sm text-gray-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-opsh-primary/20 peer ${
            ...
            <div className="mb-4 flex items-center justify-between">
              <label className="flex cursor-pointer items-center gap-2">
                <input
                  type="checkbox"
                  id="rememberMe"
                  className="form-checkbox h-4 w-4 accent-opsh-primary"
                />
