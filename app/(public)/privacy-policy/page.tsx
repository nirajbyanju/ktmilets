...
export const metadata: Metadata = buildPageMetadata({
    ...
    description:
        'Read the Samriddhi Real Estate privacy policy covering inquiries, cookies, website usage data, and visitor rights.',
    path: '/privacy-policy',
    keywords: [
        'Samriddhi privacy policy',
        'real estate privacy policy Nepal',
            ...
            <section className='container mx-auto px-4'>
                ...
                <div className="mb-8">
                    <p className="text-gray-600 text-base leading-relaxed mb-4 font-['Inter']">
                        At Samriddhi Real Estate Pvt. Ltd., accessible from <strong>https://samriddhirealestate.com.np</strong> (if applicable), one of our main priorities is the privacy of our visitors. This Privacy Policy document contains the types of information that is collected and recorded by Samriddhi Real Estate Pvt. Ltd. and how we use it.
                    </p>
                    <p className="text-gray-600 text-base leading-relaxed mb-4 font-['Inter']">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-600 text-base leading-relaxed mb-4 font-['Inter']">
                        This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they share and/or collect with Samriddhi Real Estate Pvt. Ltd. This policy is not applicable to any information collected offline or via channels other than this website.
                    </p>
                    <p className="text-gray-600 text-base leading-relaxed mb-4 font-['Inter']">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-600 text-base leading-relaxed mb-4 font-['Inter']">
                        If you contact us directly (via phone, email, or our website forms), we may receive additional information about you such as your name, email address, phone number, the contents of the message and/or attachments you may send us, and any other information you may choose to provide regarding your property needs (e.g., property type, budget, location preferences).
                    </p>
                    <p className="text-gray-600 text-base leading-relaxed mb-4 font-['Inter']">
                        Unlike services requiring a formal account, we primarily collect information through inquiry forms. We may ask for your contact information, including items such as name, email address, and telephone number to facilitate your real estate requests.
                    </p>
                </div>
                ...
                <div className="mb-8">
                    ...
                    <ul className="list-disc pl-6 text-gray-600 text-base leading-relaxed mb-4 font-['Inter'] space-y-1">
                        ...
                        <li>Communicate with you, including for customer service, to provide you with property updates, market insights, relevant real estate opportunities, and for marketing and promotional purposes.</li>
                        <li>Send you emails regarding new listings or responses to your inquiries.</li>
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-600 text-base leading-relaxed mb-4 font-['Inter']">
                        Samriddhi Real Estate Pvt. Ltd.'s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options.
                    </p>
                    <p className="text-gray-600 text-base leading-relaxed mb-4 font-['Inter']">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-600 text-base leading-relaxed mb-4 font-['Inter']">
                        Samriddhi Real Estate Pvt. Ltd. does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately, and we will do our best efforts to promptly remove such information from our records.
                    </p>
                </div>
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-600 text-base leading-relaxed mb-4 font-['Inter']">
                        In the event that you detect any unauthorized use of your personal information, you commit to promptly notify Samriddhi Real Estate Pvt. Ltd. by contacting us.
                    </p>
                </div>
                ...
                <div className="mb-8">
                    ...
                    <div className="mt-4 bg-gray-50 p-6 rounded-lg">
                        <p className="text-gray-600 text-base leading-relaxed font-['Inter'] mb-2">
                            <strong className="font-semibold">Samriddhi Real Estate Pvt. Ltd.</strong>
                        </p>
                        ...
                        <p className="text-gray-600 text-base leading-relaxed font-['Inter']">
                            <strong>Email:</strong> samriddhirealestate2026@gmail.com
                        </p>
                        <p className="text-gray-600 text-base leading-relaxed font-['Inter']">
